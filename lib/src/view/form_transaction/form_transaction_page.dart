...
import 'widgets/modal_quick_add_person.dart';
...
class _FormTransactionPageState extends State<FormTransactionPage> {
  ...
  final _descriptionDateController = TextEditingController();
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                            ...
                            child: IconButton(
                              onPressed: () async {
                                await showDialog(
                                  context: context,
                                  builder: (ctx) {
                                    return const ModalQuickAddPerson();
                                  },
                                );
                              },
                              icon: const Icon(
                    ...
                    ...[
                      Text('Tanggal Pengembalian', style: bodyFont),
                      const SizedBox(height: 8.0),
                      TextFormField(
                        ...
                        children: [
                          Expanded(
                            child: OutlinedButton(
                              onPressed: () {
                                setState(() => _selectedTransactionType = TransactionType.piutang);
                              },
                              style: OutlinedButton.styleFrom(
                                padding: const EdgeInsets.all(16.0),
                                side: const BorderSide(color: secondaryDark),
                                backgroundColor: _selectedTransactionType == TransactionType.piutang
                                    ? secondaryDark
                                    : null,
                              ),
                              child: Text(
                          ...
                          Expanded(
                            child: OutlinedButton(
                              ...
                              style: OutlinedButton.styleFrom(
                                padding: const EdgeInsets.all(16.0),
                                side: const BorderSide(color: secondaryDark),
                                backgroundColor: _selectedTransactionType == TransactionType.hutang
                                    ? secondaryDark
                                    : null,
                              ),
                              child: Text(
                          ...
                          Expanded(
                            child: OutlinedButton(
                              ...
                              style: OutlinedButton.styleFrom(
                                padding: const EdgeInsets.all(16.0),
                                side: const BorderSide(color: secondaryDark),
                                backgroundColor: _selectedPaymentStatus == PaymentStatus.notPaidOff
                                    ? secondaryDark
                                    : null,
                              ),
                              child: Text(
