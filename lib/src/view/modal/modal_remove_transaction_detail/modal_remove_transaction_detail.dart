...
class ModalRemoveTransactionDetail extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ref.listen<AsyncValue>(
      transactionDetailActionNotifier.select((value) => value.delete),
      (_, state) {
    ...
    return AlertDialog(
      ...
      actions: [
        ElevatedButton(
          onPressed: () async {
            await ref.read(transactionDetailActionNotifier.notifier).deleteTransactionDetail(id);
          },
