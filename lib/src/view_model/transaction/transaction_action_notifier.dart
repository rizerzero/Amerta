...
import '../../model/model/transaction/transaction_form_parameter.dart';
...
class TransactionActionNotifier extends StateNotifier<TransactionActionState> {
  ...
  Future<TransactionActionState> insertOrUpdateTransaction(TransactionFormParameter form) async {
